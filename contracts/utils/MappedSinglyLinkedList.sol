...
/// @dev A mapping(address => address) tracks the 'next' pointer.
///      A special address called the SENTINEL is used to denote the beginning and end of the list.
library MappedSinglyLinkedList {
    ...
    /// @param self The Mapping struct that this function is attached to
    /// @param prevAddress An address that precedes the address to be removed. This may be the SENTINEL if at the start.
